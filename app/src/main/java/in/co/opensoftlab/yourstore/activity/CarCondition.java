...
public class CarCondition extends AppCompatActivity implements View.OnClickListener, AddConditionRating.conditionCompleted {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Fragment fragment = AddConditionRating.newInstance("car", 8, bundle.getString("dataKey"));
...
//                break;
    ...
    public void conditionCompleteEvent() {
        ...
        Intent intent = new Intent(CarCondition.this, AddProductImage.class);
    ...
    private void warnUser() {
        final AlertDialog.Builder alertDiallogBuilder = new AlertDialog.Builder(CarCondition.this);
