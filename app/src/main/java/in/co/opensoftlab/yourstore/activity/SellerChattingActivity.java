...
import in.co.opensoftlab.yourstore.adapter.ChatMessageAdapterSeller;
...
public class SellerChattingActivity extends AppCompatActivity {
    ...
    private ChatMessageAdapterSeller mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatBuyer = FirebaseDatabase.getInstance().getReference(getResources().getString(R.string.server_chat)).child("buyer").child(bundle.getString("buyerId"));
        mChatSeller = FirebaseDatabase.getInstance().getReference(getResources().getString(R.string.server_chat)).child("seller").child(getUserUID());

        mChatSeller.child(bundle.getString("chatId")).child("unreadMsg").setValue(0);
        ...
        buyerName = (TextView) findViewById(R.id.tv_name);
        title = (TextView) findViewById(R.id.tv_store_name);
        ...
        Picasso.with(this)
                .load(bundle.getString("buyerUrl"))
                .into(sellerImg);
        buyerName.setText(bundle.getString("buyerName"));
        title.setText(bundle.getString("title"));

        mRecyclerView.setLayoutManager(new LinearLayoutManager(this));

        mAdapter = new ChatMessageAdapterSeller(this, chatMessageList);
    ...
    protected void onPause() {
        super.onPause();
        mChatBuyer.removeEventListener(chatStatusListener);
    ...
    protected void onResume() {
        super.onResume();
        mChatBuyer.child(bundle.getString("chatId")).addValueEventListener(chatStatusListener);
        mDatabase.orderByKey().limitToLast(200).addValueEventListener(valueEventListener);
        mChatSeller.child(bundle.getString("chatId")).child("metaInfo").setValue("Online");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        mChatSeller.child(bundle.getString("chatId")).child("metaInfo").setValue("Offline");
    }
