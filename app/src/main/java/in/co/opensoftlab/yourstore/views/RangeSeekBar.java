package in.co.opensoftlab.yourstore.views;
...
import in.co.opensoftlab.yourstore.utils.PixelUtil;

public class RangeSeekBar<T extends Number> extends AppCompatImageView {

    public static final Integer DEFAULT_MINIMUM = 0;
    public static final Integer DEFAULT_MAXIMUM = 100000;
    public static final int HEIGHT_IN_DP = 48;
    public static final int TEXT_LATERAL_PADDING_IN_DP = 3;
    private static final int INITIAL_PADDING_IN_DP = 8;
    private final int LINE_HEIGHT_IN_DP = 2;
    private final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private final Bitmap thumbImage = BitmapFactory.decodeResource(getResources(), R.drawable.icon_rangebar);
    private final Bitmap thumbPressedImage = BitmapFactory.decodeResource(getResources(),
            R.drawable.icon_rangebar);
    ...
    public static final int DEFAULT_COLOR = Color.rgb(0xFE, 0x97, 0x00);
    /**
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs == null) {
            ...
            setRangeValues(
                    extractNumericValueFromAttributes(a, R.styleable.RangeBar_absoluteMinValue, DEFAULT_MINIMUM),
                    extractNumericValueFromAttributes(a, R.styleable.RangeBar_absoluteMaxValue, DEFAULT_MAXIMUM));
